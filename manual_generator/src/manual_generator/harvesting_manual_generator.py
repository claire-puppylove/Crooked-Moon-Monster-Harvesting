...
# rename to HarvestingManualGenerator because there's other types of manual now.
class HarvestingManualGenerator:
    '''
        ...
        if self.version=="dm":
            ...
            for x in range(len(sourcefile)):
                ...
                try:
                    ...
                    raise RuntimeError(f"Error in row:{row}") from e
